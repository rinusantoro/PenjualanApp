...
public class FormCustomer extends JFrame {
    ...
    JTextField txtId, txtNama, txtAlamat, txtHP;
    JTable table;
    ...
    public FormCustomer() {
        ...
        formPanel.setBorder(new TitledBorder("Input Data Customer"));
        ...
        addField(formPanel, gbc, 1, "Nama", txtNama);
        addField(formPanel, gbc, 2, "Alamat", txtAlamat);
        addField(formPanel, gbc, 3, "No HP", txtHP);
        ...
        model = new DefaultTableModel(
                new String[]{"ID","Nama","Alamat","No HP"},0
        );

        table = new JTable(model);
        JScrollPane scroll = new JScrollPane(table);
        scroll.setBorder(new TitledBorder("Data Customer"));
    ...
    void simpan() {
        try {
            ...
            String sql = "INSERT INTO customer(nama,alamat,no_hp) VALUES(?,?,?)";
    ...
    void update() {
        try {
            ...
            Connection conn = Koneksi.getConnection();
            String sql = "UPDATE customer SET nama=?, alamat=?, no_hp=? WHERE id_customer=?";
